...
<p align="center">IPA (國際音標) 是跨語言轉換學習的關鍵</p>

<p align="center">![](./fig2.jpg)</p>
<p align="center">Text input 切成若干IPA Text Embeddings，和Voice encoder output 做time warping alignment，然後利用minimize KL-Divergence的方式來確保中間的Latents IPA-Aligned features，有最大化的去除任何Tone color的成分。</p>
...
<p align="center">這張圖花了一些時間製作，把論文裡面補充的內容都放了進去</p>
