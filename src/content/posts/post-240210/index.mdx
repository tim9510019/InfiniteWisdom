...
<p align="center">壓縮大型圖片或是大型3D場景可以達到很好的效果，但是對於原本檔案就比較小的圖片，比較沒有競爭優勢，不過作者仍然有提供一些有競爭力的設定</p>

<p align="center">![](./fig5.jpg)</p>
<p align="center">![](./fig6.jpg)</p>
<p align="center">壓縮小型圖片檔案比較沒有效益，因為這個方法的低銷比較高，但是對於8K圖像的壓縮，則是大有斬獲</p>
...
<p align="center">要降低小型圖片的壓縮低銷容量，可以使用比較少的Multiple Resolution Estimation，或是降低Neuron的數目，或是可以同時雙管齊下</p>
